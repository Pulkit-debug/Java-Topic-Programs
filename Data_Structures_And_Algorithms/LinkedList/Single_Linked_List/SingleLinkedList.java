package Data_Structures_And_Algorithms.LinkedList.Single_Linked_List;

import Data_Structures_And_Algorithms.LinkedList.Node.SingleNode;

//import Data_Structures_And_Algorithms.LinkedList.SingleLinkedList.SingleNode;
...
public class SingleLinkedList {
	...
	public SingleNode getHead() {	// The first four functions are for stack
		return head;
	}
	...
	public void insertInLinkedList(int nodeValue, int location) {
		...
		if (!existsLinkedList()) { // Linked List does not exists
			...
			int index = 0;
			while (index < location) {// loop till we reach specified node
